...
- *The resting potential*: this is when the neuron is not excited and has "nothing to say". Its electrical charge is then negative compared to its environment: -70mV
- When the neuron receives a signal through its dendrites, its membrane will open, the ions will change their distribution, and overall the net effect will be that the neuron is more positively charged : +30mV. It is then in a state called *Action Potential*
...
Let's talk about these connections: between the axon terminals of an emitting neuron and the dendrites of a receiving neuron, there is a space called the *synapse*.

Through the synapse, the axon will send chemical compounds called *neurotransmitters*, which are received by the dendrites of the receiving neuron. The more neurotransmitters received, the stronger the transmitted signal.
...
It certainly comes from the time where our ancestors were living in the Savanah: if something moves in a bush, it is much better to throw an alert through the amygdala (this is a lion!) , run away and think later. In case it was actually a lion, the amygdala saved our life. The guy staying there thinking "Maybe it is a lion, maybe not, i am not sure, let's check it out" would not have survived and passed its genes.

But this life-saving feature comes with a lot of drawbacks...

The amygdala is preponderant in aggression : when it is stimulated, the aggressivity of an individual increases.
...
Another limitation: compared to the rest of the brain, the neocortex is quite slow to process information... it is the perfect antagonist of the amygdala: when the neocortex is slow but with highly accurate, the amygdala and the limbic system are super fast, but grossly inaccurate.
...
We know that the quickest to react will be the limbic system, thanks to its very fast circuitry. At this moment, the brain will a rough idea of what is going on and start experiencing emotions, *but it is not yet conscious of it*.

Then the information will arrive to the neocortex that will process it.
